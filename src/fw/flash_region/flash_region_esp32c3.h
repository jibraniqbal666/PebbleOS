...
// Minimal flash layout for ESP32-C3 bootloader support
// ESP32-C3 typically has 4MB flash
// Bootloader is 32KB at 0x0, so firmware starts at 0x8000
// We use FLASH_REGION_BASE_ADDRESS to account for the bootloader offset
#define FLASH_REGION_BASE_ADDRESS 0x8000  // Bootloader offset

#define FLASH_REGION_DEF(MACRO, arg) \
  MACRO(FIRMWARE_SLOT_1,          0x100000 /* 1024k */, arg) /* 0x8000 - 0x108000 */ \
...
// ESP32-C3 only has FIRMWARE_SLOT_1, alias FIRMWARE_SLOT_0 to FIRMWARE_SLOT_1 for compatibility
#define FLASH_REGION_FIRMWARE_SLOT_0_BEGIN FLASH_REGION_FIRMWARE_SLOT_1_BEGIN
#define FLASH_REGION_FIRMWARE_SLOT_0_END FLASH_REGION_FIRMWARE_SLOT_1_END
...
// Note: For ESP32-C3, we're using a simplified layout that fits within 4MB
// The actual size will be less than 4MB due to bootloader space
